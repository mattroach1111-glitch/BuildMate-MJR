...
## Recent Changes
- **August 11, 2025**: Enhanced weekend visibility on timesheets with royal blue highlighting. Weekend rows (Saturdays and Sundays) now feature prominent royal blue background (bg-blue-600), dark blue borders (border-blue-700), white text for maximum contrast, and white input fields with light blue placeholders to prevent confusion with weekdays. Applied consistently across all timesheet interfaces.
