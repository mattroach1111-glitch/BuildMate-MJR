...
## Recent Changes
- **August 11, 2025**: Streamlined staff experience by routing directly to the full fortnight timesheet interface. Removed confusing intermediate dashboard to provide staff with immediate access to the comprehensive timesheet view with calendar, entry management, and submission capabilities. Enhanced staff management system with comprehensive user control for admins including delete and reset functions.
