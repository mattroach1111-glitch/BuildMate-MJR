...
# Recent Changes
- **August 15, 2025**: **IN PROGRESS**: Refined landscape mode for full viewport and smooth scrolling. Fixed viewport sizing to fill entire screen using position:fixed with translate3d centering. Added hardware acceleration and momentum scrolling optimizations for smooth performance. Also moved job sheet PDF buttons from fixed header to scrollable content area for better mobile accessibility.
