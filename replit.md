...
# Recent Changes
- **August 15, 2025**: **IN PROGRESS**: Fixed landscape mode viewport cropping issue. Completely rewrote landscape CSS to eliminate "half screen gone" problem by using natural positioning with transform-only rotation. Removed complex positioning calculations that caused viewport issues. Also moved job sheet PDF buttons from fixed header to scrollable content area for better mobile accessibility.
