...
## Recent Changes
- **August 12, 2025**: ✅ COMPLETED AI DOCUMENT PROCESSING - Implemented comprehensive AI-powered expense extraction for image documents (JPG, PNG). Features include enhanced drag-and-drop upload, intelligent expense categorization, vendor/amount extraction, and automatic addition to job sheets. Upload system fully operational with proper job selection, duplicate handling, and seamless integration with Anthropic AI. PDF support postponed due to system dependencies - users guided to upload images instead (phone camera photos work excellently).
