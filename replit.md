...
## Recent Changes
- **August 11, 2025**: Enhanced weekend visibility on timesheets with prominent blue highlighting. Weekend rows (Saturdays and Sundays) now feature vibrant blue background (bg-blue-200), blue borders, dark blue text for dates (text-blue-900), and bold "(Weekend)" labels to prevent confusion with weekdays. Applied consistently across all timesheet interfaces.
