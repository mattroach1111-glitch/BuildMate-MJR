...
# Recent Changes
- **August 14, 2025**: Added mobile orientation toggle feature for easier viewing on phones. A floating button in bottom-right corner allows users to switch between portrait and landscape modes for better viewing of job sheets and timesheet data on mobile devices.
