...
## Recent Changes
- **August 12, 2025**: ✅ RESOLVED DATA DISPLAY ISSUE - Fixed job folder display after database preparation for second business testing. Modified default grouping to show familiar Mark and Will project manager folders instead of client folders. All original business data preserved (10 jobs, 10 employees, users intact). Only timesheet entries were cleared for clean testing environment but easily restored with sample data.
