...
## Recent Changes
- **August 11, 2025**: Enhanced staff management system with comprehensive user control for admins. Added ability to delete pending staff users (with safety validations), reset user-employee assignments for testing, and comprehensive role assignment capabilities. Users now route directly to full timesheet interface for streamlined staff experience.
