...
# Recent Changes
- **August 14, 2025**: Enhanced mobile orientation toggle with stable landscape positioning. Fixed layout shift issues by implementing consistent absolute positioning for root elements, proper margin/padding resets, and complete cleanup when switching orientations. The landscape mode now maintains stable positioning without jarring page movements.
- **August 14, 2025**: Added mobile orientation toggle feature with comprehensive landscape mode support for easier viewing on phones. A floating button in bottom-right corner allows users to switch between portrait and landscape modes, with properly positioned modals, dialogs, and dropdown menus that work correctly in both orientations.
