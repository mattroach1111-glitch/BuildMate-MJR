...
# Recent Changes
- **August 15, 2025**: **RESOLVED**: Disabled landscape mode feature due to browser compatibility issues and focused on core functionality. Successfully moved job sheet PDF buttons (Download PDF, Email PDF) from fixed header to scrollable content area for better mobile accessibility. Users can now physically rotate their phones for landscape viewing, which works reliably with all mobile browsers.
