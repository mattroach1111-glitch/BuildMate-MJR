...
# Recent Changes
- **August 14, 2025**: Added mobile orientation toggle feature with improved positioning for easier viewing on phones. A floating button in bottom-right corner allows users to switch between portrait and landscape modes, with refined centering calculations to keep content properly visible in landscape mode.
