...
export const quotes = pgTable("quotes", {
  ...
  depositType: varchar("deposit_type", { enum: ["percentage", "fixed"] }).notNull().default("percentage"),
  depositValue: decimal("deposit_value", { precision: 10, scale: 2 }).notNull().default("0"),
