...
-- Started on 2025-08-18 08:00:10 UTC
...
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_employee_id_employees_id_fk;
ALTER TABLE IF EXISTS ONLY public.tip_fees DROP CONSTRAINT IF EXISTS tip_fees_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.timesheet_entries DROP CONSTRAINT IF EXISTS timesheet_entries_staff_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.timesheet_entries DROP CONSTRAINT IF EXISTS timesheet_entries_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.sub_trades DROP CONSTRAINT IF EXISTS sub_trades_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.staff_notes_entries DROP CONSTRAINT IF EXISTS staff_notes_entries_staff_member_id_staff_members_id_fk;
ALTER TABLE IF EXISTS ONLY public.staff_notes DROP CONSTRAINT IF EXISTS staff_notes_employee_id_employees_id_fk;
ALTER TABLE IF EXISTS ONLY public.staff_notes DROP CONSTRAINT IF EXISTS staff_notes_created_by_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.reward_transactions DROP CONSTRAINT IF EXISTS reward_transactions_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.reward_redemptions DROP CONSTRAINT IF EXISTS reward_redemptions_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.reward_redemptions DROP CONSTRAINT IF EXISTS reward_redemptions_approved_by_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.reward_points DROP CONSTRAINT IF EXISTS reward_points_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.reward_achievements DROP CONSTRAINT IF EXISTS reward_achievements_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.other_costs DROP CONSTRAINT IF EXISTS other_costs_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.materials DROP CONSTRAINT IF EXISTS materials_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.labor_entries DROP CONSTRAINT IF EXISTS labor_entries_staff_id_employees_id_fk;
ALTER TABLE IF EXISTS ONLY public.labor_entries DROP CONSTRAINT IF EXISTS labor_entries_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.job_update_notes DROP CONSTRAINT IF EXISTS job_update_notes_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.job_notes DROP CONSTRAINT IF EXISTS job_notes_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.job_notes DROP CONSTRAINT IF EXISTS job_notes_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.job_files DROP CONSTRAINT IF EXISTS job_files_uploaded_by_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.job_files DROP CONSTRAINT IF EXISTS job_files_job_id_jobs_id_fk;
ALTER TABLE IF EXISTS ONLY public.email_processed_documents DROP CONSTRAINT IF EXISTS email_processed_documents_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.email_processed_documents DROP CONSTRAINT IF EXISTS email_processed_documents_job_id_jobs_id_fk;
DROP INDEX IF EXISTS public."IDX_session_expire";
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_unique;
ALTER TABLE IF EXISTS ONLY public.tip_fees DROP CONSTRAINT IF EXISTS tip_fees_pkey;
ALTER TABLE IF EXISTS ONLY public.timesheet_entries DROP CONSTRAINT IF EXISTS timesheet_entries_pkey;
ALTER TABLE IF EXISTS ONLY public.sub_trades DROP CONSTRAINT IF EXISTS sub_trades_pkey;
ALTER TABLE IF EXISTS ONLY public.staff_notes DROP CONSTRAINT IF EXISTS staff_notes_pkey;
ALTER TABLE IF EXISTS ONLY public.staff_notes_entries DROP CONSTRAINT IF EXISTS staff_notes_entries_pkey;
...
ALTER TABLE IF EXISTS ONLY public.reward_settings DROP CONSTRAINT IF EXISTS reward_settings_setting_key_unique;
...
ALTER TABLE IF EXISTS ONLY public.reward_catalog DROP CONSTRAINT IF EXISTS reward_catalog_pkey;
ALTER TABLE IF EXISTS ONLY public.reward_achievements DROP CONSTRAINT IF EXISTS reward_achievements_pkey;
ALTER TABLE IF EXISTS ONLY public.other_costs DROP CONSTRAINT IF EXISTS other_costs_pkey;
...
ALTER TABLE IF EXISTS ONLY public.job_update_notes DROP CONSTRAINT IF EXISTS job_update_notes_pkey;
ALTER TABLE IF EXISTS ONLY public.job_notes DROP CONSTRAINT IF EXISTS job_notes_pkey;
ALTER TABLE IF EXISTS ONLY public.job_files DROP CONSTRAINT IF EXISTS job_files_pkey;
ALTER TABLE IF EXISTS ONLY public.employees DROP CONSTRAINT IF EXISTS employees_pkey;
ALTER TABLE IF EXISTS ONLY public.email_processing_logs DROP CONSTRAINT IF EXISTS email_processing_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.email_processed_documents DROP CONSTRAINT IF EXISTS email_processed_documents_pkey;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.tip_fees;
DROP TABLE IF EXISTS public.timesheet_entries;
DROP TABLE IF EXISTS public.sub_trades;
DROP TABLE IF EXISTS public.staff_notes_entries;
...
DROP TABLE IF EXISTS public.reward_achievements;
...
DROP TABLE IF EXISTS public.job_update_notes;
DROP TABLE IF EXISTS public.job_notes;
DROP TABLE IF EXISTS public.job_files;
DROP TABLE IF EXISTS public.employees;
DROP TABLE IF EXISTS public.email_processing_logs;
DROP TABLE IF EXISTS public.email_processed_documents;
SET default_tablespace = '';

SET default_table_access_method = heap;

--
-- TOC entry 228 (class 1259 OID 581638)
-- Name: email_processed_documents; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 227 (class 1259 OID 557057)
...
--
-- TOC entry 238 (class 1259 OID 1589248)
...
--
-- TOC entry 239 (class 1259 OID 1638400)
-- Name: job_update_notes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 225 (class 1259 OID 196608)
...
--
-- TOC entry 223 (class 1259 OID 40970)
-- Name: other_costs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 232 (class 1259 OID 1474560)
-- Name: reward_achievements; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 233 (class 1259 OID 1474570)
...
--
-- TOC entry 234 (class 1259 OID 1474581)
...
--
-- TOC entry 235 (class 1259 OID 1474596)
...
--
-- TOC entry 237 (class 1259 OID 1540096)
...
--
-- TOC entry 236 (class 1259 OID 1474606)
...
--
-- TOC entry 230 (class 1259 OID 1449984)
...
--
-- TOC entry 229 (class 1259 OID 1368064)
...
--
-- TOC entry 231 (class 1259 OID 1449997)
-- Name: staff_notes_entries; Type: TABLE; Schema: public; Owner: -
--
...
-- Name: sub_trades; Type: TABLE; Schema: public; Owner: -
--
...
-- Name: tip_fees; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 3598 (class 0 OID 581638)
-- Dependencies: 228
-- Data for Name: email_processed_documents; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3597 (class 0 OID 557057)
-- Dependencies: 227
-- Data for Name: email_processing_logs; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3592 (class 0 OID 40961)
-- Dependencies: 222
...
--
-- TOC entry 3594 (class 0 OID 131072)
-- Dependencies: 224
-- Data for Name: job_files; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3608 (class 0 OID 1589248)
-- Dependencies: 238
...
--
-- TOC entry 3609 (class 0 OID 1638400)
-- Dependencies: 239
-- Data for Name: job_update_notes; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3586 (class 0 OID 24594)
-- Dependencies: 216
...
--
-- TOC entry 3587 (class 0 OID 24605)
-- Dependencies: 217
...
--
-- TOC entry 3595 (class 0 OID 196608)
-- Dependencies: 225
...
--
-- TOC entry 3593 (class 0 OID 40970)
-- Dependencies: 223
-- Data for Name: other_costs; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3602 (class 0 OID 1474560)
-- Dependencies: 232
-- Data for Name: reward_achievements; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3603 (class 0 OID 1474570)
-- Dependencies: 233
...
--
-- TOC entry 3604 (class 0 OID 1474581)
-- Dependencies: 234
...
--
-- TOC entry 3605 (class 0 OID 1474596)
-- Dependencies: 235
...
--
-- TOC entry 3607 (class 0 OID 1540096)
-- Dependencies: 237
...
--
-- TOC entry 3606 (class 0 OID 1474606)
-- Dependencies: 236
...
--
-- TOC entry 3588 (class 0 OID 24614)
-- Dependencies: 218
...
eRKnXm20Vsr824LgDRB6sdAQGyFTMUNp	{"cookie": {"path": "/", "secure": true, "expires": "2025-08-25T05:47:53.689Z", "httpOnly": true, "originalMaxAge": 604800000}, "passport": {"user": {"claims": {"aud": "002d9a91-7cf2-4585-8a06-1d3444a86ebf", "exp": 1755499673, "iat": 1755496073, "iss": "https://replit.com/oidc", "sub": "46214248", "email": "mattroach1111@gmail.com", "at_hash": "JKsa2LJ73vfaIKugd8Jw5A", "username": "mattroach1111", "auth_time": 1755168810, "last_name": null, "first_name": null}, "expires_at": 1755499673, "access_token": "aEr7Ay6tKnnHtV8dCAJ2nSOYAKtPGUUSm2q4TatTLRr", "refresh_token": "-OmLRbOql7mqvrifzlwX2VQBkv9uMtJj4XXEAFR9vB5"}}}	2025-08-25 05:47:57
\.


--
-- TOC entry 3600 (class 0 OID 1449984)
-- Dependencies: 230
...
--
-- TOC entry 3599 (class 0 OID 1368064)
-- Dependencies: 229
...
--
-- TOC entry 3601 (class 0 OID 1449997)
-- Dependencies: 231
-- Data for Name: staff_notes_entries; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3589 (class 0 OID 24621)
-- Dependencies: 219
-- Data for Name: sub_trades; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3590 (class 0 OID 24630)
-- Dependencies: 220
...
--
-- TOC entry 3596 (class 0 OID 204800)
-- Dependencies: 226
-- Data for Name: tip_fees; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- TOC entry 3591 (class 0 OID 24640)
-- Dependencies: 221
...
--
-- TOC entry 3392 (class 2606 OID 581647)
-- Name: email_processed_documents email_processed_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3390 (class 2606 OID 557068)
...
--
-- TOC entry 3380 (class 2606 OID 40969)
...
--
-- TOC entry 3384 (class 2606 OID 131080)
...
--
-- TOC entry 3414 (class 2606 OID 1589257)
...
--
-- TOC entry 3416 (class 2606 OID 1638409)
-- Name: job_update_notes job_update_notes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3363 (class 2606 OID 24591)
...
--
-- TOC entry 3365 (class 2606 OID 24604)
...
--
-- TOC entry 3367 (class 2606 OID 24613)
...
--
-- TOC entry 3382 (class 2606 OID 40978)
-- Name: other_costs other_costs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3400 (class 2606 OID 1474569)
-- Name: reward_achievements reward_achievements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3402 (class 2606 OID 1474580)
...
--
-- TOC entry 3404 (class 2606 OID 1474595)
...
--
-- TOC entry 3406 (class 2606 OID 1474605)
...
--
-- TOC entry 3410 (class 2606 OID 1540104)
...
--
-- TOC entry 3412 (class 2606 OID 1540106)
-- Name: reward_settings reward_settings_setting_key_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3408 (class 2606 OID 1474614)
...
--
-- TOC entry 3370 (class 2606 OID 24620)
...
--
-- TOC entry 3396 (class 2606 OID 1449996)
...
--
-- TOC entry 3398 (class 2606 OID 1450005)
-- Name: staff_notes_entries staff_notes_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3394 (class 2606 OID 1368074)
...
--
-- TOC entry 3372 (class 2606 OID 24629)
-- Name: sub_trades sub_trades_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3374 (class 2606 OID 24639)
...
--
-- TOC entry 3388 (class 2606 OID 204808)
-- Name: tip_fees tip_fees_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3376 (class 2606 OID 24652)
...
--
-- TOC entry 3378 (class 2606 OID 24650)
...
--
-- TOC entry 3368 (class 1259 OID 24683)
...
--
-- TOC entry 3429 (class 2606 OID 581653)
-- Name: email_processed_documents email_processed_documents_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3430 (class 2606 OID 581648)
-- Name: email_processed_documents email_processed_documents_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3425 (class 2606 OID 131081)
-- Name: job_files job_files_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3426 (class 2606 OID 131086)
-- Name: job_files job_files_uploaded_by_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3439 (class 2606 OID 1589258)
-- Name: job_notes job_notes_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3440 (class 2606 OID 1589263)
-- Name: job_notes job_notes_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3441 (class 2606 OID 1638410)
-- Name: job_update_notes job_update_notes_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3417 (class 2606 OID 24653)
-- Name: labor_entries labor_entries_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3418 (class 2606 OID 65536)
-- Name: labor_entries labor_entries_staff_id_employees_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3419 (class 2606 OID 24663)
-- Name: materials materials_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3427 (class 2606 OID 196618)
...
--
-- TOC entry 3424 (class 2606 OID 49152)
-- Name: other_costs other_costs_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3434 (class 2606 OID 1474615)
-- Name: reward_achievements reward_achievements_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3435 (class 2606 OID 1474620)
...
--
-- TOC entry 3436 (class 2606 OID 1474630)
-- Name: reward_redemptions reward_redemptions_approved_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3437 (class 2606 OID 1474625)
-- Name: reward_redemptions reward_redemptions_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3438 (class 2606 OID 1474635)
-- Name: reward_transactions reward_transactions_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3431 (class 2606 OID 1368080)
-- Name: staff_notes staff_notes_created_by_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3432 (class 2606 OID 1368075)
-- Name: staff_notes staff_notes_employee_id_employees_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3433 (class 2606 OID 1450006)
-- Name: staff_notes_entries staff_notes_entries_staff_member_id_staff_members_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3420 (class 2606 OID 24668)
-- Name: sub_trades sub_trades_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3421 (class 2606 OID 24678)
-- Name: timesheet_entries timesheet_entries_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3422 (class 2606 OID 24673)
-- Name: timesheet_entries timesheet_entries_staff_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3428 (class 2606 OID 204809)
-- Name: tip_fees tip_fees_job_id_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3423 (class 2606 OID 122881)
-- Name: users users_employee_id_employees_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Completed on 2025-08-18 08:00:17 UTC
